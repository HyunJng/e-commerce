...
INSERT INTO users(id, create_at)
VALUES(2, '2025-07-22 10:00:00');

INSERT INTO wallets(user_id, balance, create_at, update_at)
VALUES (1, 100000, '2025-07-22 10:00:00', '2025-07-22 10:00:00');
INSERT INTO wallets(user_id, balance, create_at, update_at)
VALUES (2, 200000, '2025-07-22 10:00:00', '2025-07-22 10:00:00');


INSERT INTO products (id, name, price, stock_quantity)
VALUES (1, 'Product A', 1000, 1),
       (2, 'Product B', 2000, 5),
       (3, 'Product C', 3000, 10);

INSERT INTO coupons(id, name, discount_amount, discount_type, dates, state, create_at, update_at)
VALUES (1, '10% OFF', 10, 'PERCENT', 30, 'ACTIVE', '2025-07-22 10:00:00', '2025-07-22 10:00:00');

INSERT INTO coupons_quantity(id, coupon_id, total_quantity, issued_quantity, create_at, update_at)
