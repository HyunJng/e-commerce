...
public class WalletLockLoader {
    ...
    private final WalletJpaLockRepository walletJpaLockRepository;

    public Optional<Wallet> get(Long userId) {
        try {
            return walletJpaLockRepository.findByUserIdForUpdate(userId);
